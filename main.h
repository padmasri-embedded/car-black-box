...
#define DASHBOARD_SCREEN        0x01    /* when in dashboard screen */
#define LOGIN_SCREEN            0x02    /* when in login screen */
#define MAINMENU_SCREEN         0x03    /* when in login menu screen */
#define VIEW_LOG                0x08    /* when in view log screen */
#define CLEAR_LOG               0x09    /* when in clear log screen */
#define DOWNLOAD_LOG            0x10    /* when in download log screen */
#define CHANGE_PASSWRD       	0x11    /* when in change password screen */
#define SET_TIME         		0x12    /* when in set time screen */
